...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "488242fa2b1f98a9c5bd1441297fb4a99a6a9ae4"
  WORKING_DIRECTORY "/Users/yingjie/Documents/spatialLink/ext/libigl/cmake/../external/predicates"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/yingjie/Documents/spatialLink/ext/libigl/cmake/../external/predicates'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/yingjie/Documents/spatialLink/ext/libigl/cmake/../external/predicates'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
