...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "d175e9de0be0d4db75d0a8cf065599a435a87eb6"
  WORKING_DIRECTORY "/Users/yingjie/Documents/spatialLink/ext/libigl/cmake/../external/tinyxml2"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/yingjie/Documents/spatialLink/ext/libigl/cmake/../external/tinyxml2'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/yingjie/Documents/spatialLink/ext/libigl/cmake/../external/tinyxml2'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
